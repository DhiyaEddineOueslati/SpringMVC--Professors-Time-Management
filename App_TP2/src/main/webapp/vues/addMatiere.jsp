...
<body>
    ...
    <form action="${cxt}/saveMatiere" method="post">
        ...
        <input type="number" id="nombreHeures" name="nombreHeures" required>

        <input type="submit" value="Ajouter">
    </form>

    <a href="${cxt}/matieres">Retour à la liste des matières</a>
